            ...
            {categories.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  : "bg-transparent border-border text-gray-500 hover:border-brand-green/50 hover:text-foreground"
                )}
              >
                {cat}
              </button>
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-[10001] flex items-center justify-center p-6 md:p-12">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-5xl bg-card-bg border border-border rounded-[3rem] overflow-hidden shadow-2xl flex flex-col md:flex-row"
            >
              ...
              <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                <button 
                  onClick={() => setSelectedProject(null)}
                  className="absolute top-8 right-8 w-12 h-12 rounded-full border border-border flex items-center justify-center text-foreground hover:bg-brand-green hover:text-black transition-all"
                >
                ...
                <div className="flex flex-wrap gap-6">
                  <Magnetic>
                    <a href={selectedProject.liveUrl} target="_blank" className="px-8 py-4 bg-brand-green text-black font-bold rounded-2xl flex items-center gap-2 hover:shadow-lg transition-all">
                      Live Demo
                  ...
                  <Magnetic>
                    <a href={selectedProject.repoUrl} target="_blank" className="px-8 py-4 border border-border text-foreground font-bold rounded-2xl flex items-center gap-2 hover:bg-white/5 transition-all">
                      GitHub
...
function ProjectCard({ project, index, onView, onHover }) {
  ...
  return (
    <motion.div
      ...
      onClick={onView}
    >
      <TiltCard className="group relative aspect-[4/5] md:aspect-[16/10] rounded-[2.5rem] overflow-hidden bg-card-bg border border-border shadow-2xl cursor-none">
        {/* Parallax Image */}
            ...
            <div className="flex items-center gap-8">
              ...
              <div className="flex gap-4">
                <Magnetic strength={0.5}>
                  <div className="w-12 h-12 rounded-full bg-brand-green text-black flex items-center justify-center shadow-lg">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
