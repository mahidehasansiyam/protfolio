...
const contactLinks = [
  {
    label: "EMAIL",
    value: "mkkhalidmahamud@gmail.com",
    href: "mailto:mkkhalidmahamud@gmail.com",
    icon: (
  ...
  {
    label: "WHATSAPP",
    value: "+880 188991-7987",
    href: "https://wa.me/8801889917987",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LINKEDIN",
    value: "linkedin.com/in/mkkhalid/",
    href: "https://linkedin.com/in/mkkhalid/",
    icon: (
  ...
  },
  {
    label: "GITHUB",
    value: "@mkkhalid5",
    href: "https://github.com/mkkhalid5",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-card-bg border border-border/50 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden">
                ...
                <form className="space-y-8 relative z-10">
                  ...
                  <Magnetic strength={0.2}>
                    <button className="px-10 py-5 bg-[#E8C872] text-black font-bold rounded-full hover:shadow-[0_0_30px_rgba(232,200,114,0.4)] transition-all duration-300 flex items-center gap-3 group">
