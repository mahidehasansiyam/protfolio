          ...
          <ScrollReveal delay={1.2} animation="fade-up" className="flex flex-wrap items-center gap-6 pt-4">
            ...
            <div className="flex items-center gap-4">
              <Magnetic strength={0.4}>
                <a className="w-14 h-14 flex items-center justify-center rounded-full bg-card-bg border border-border text-foreground hover:bg-white/10 transition-colors" href="#">
