...
export default function Footer() {
  return (
    <footer className="py-32 px-6 text-center border-t border-border bg-brand-bg relative overflow-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <ScrollReveal animation="fade-up" delay={0.4}>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Magnetic>
              <a href="mailto:hello@gilberto.dev" className="text-3xl md:text-4xl font-bold text-foreground hover:text-brand-green transition-colors underline decoration-brand-green/30 underline-offset-8">
                hello@gilberto.dev
              </a>
            </Magnetic>
          </div>
        ...
        <div className="mt-32 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-6 text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Gilberto. All rights reserved.</p>
